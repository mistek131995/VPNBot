...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240711002810_deleteTelegramChatId")]
    partial class deleteTelegramChatId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Database.Entity.AccessPosition", b =>
                {
                    ...
                    b.Property<string>("GooglePlayIdentifier")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Infrastructure.Database.Entity.ConnectionStatistic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ConnectionStatistics");
                });
            ...
            modelBuilder.Entity("Infrastructure.Database.Entity.UserSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("UseEmailNotificationAboutNews")
                        .HasColumnType("bit");

                    b.Property<bool>("UseEmailNotificationLoginInError")
                        .HasColumnType("bit");

                    b.Property<bool>("UseEmailNotificationTicketMessage")
                        .HasColumnType("bit");

                    b.Property<bool>("UseTelegramNotificationAboutNews")
                        .HasColumnType("bit");

                    b.Property<bool>("UseTelegramNotificationLoginInError")
                        .HasColumnType("bit");

                    b.Property<bool>("UseTelegramNotificationTicketMessage")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Infrastructure.Database.Entity.UserSetting", b =>
                {
                    b.HasOne("Infrastructure.Database.Entity.User", "User")
                        .WithOne("UserSetting")
                        .HasForeignKey("Infrastructure.Database.Entity.UserSetting", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Infrastructure.Database.Entity.VpnServer", b =>
                {
                    ...
                    b.Navigation("ConnectionStatistics");
