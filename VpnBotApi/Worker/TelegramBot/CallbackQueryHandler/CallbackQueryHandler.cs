...
namespace VpnBotApi.Worker.TelegramBot.CallbackQueryHandler
{
    public class CallbackQueryHandler(TelegramBotServiceDispatcher dispatcher)
    {
        public async Task HandlingAsync(ITelegramBotClient client, Update update)
        {
            ...
            {
                var text = "1. Скачайте и откройте приложение.Сохраните QR, полученный у бота в галерею." +
            ...
            else if (callbackQuery.Data == "helpIOSFoxRay")
            {
                var text = "1. Сохраните QR, полученный у бота в галерею." +
                            "\n2. Скачайте и откройте приложение." +
                            "\n3. Нажмите на икноку изображения в верхнем меню и выберите изображение с QR кодом." +
                            "\n4. Под верхнем меню появилось новое поделючение, нажмите на кнопку запуска.";
